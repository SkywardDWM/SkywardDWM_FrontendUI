...
export class RoleAddEditComponent implements OnInit, OnDestroy {
    ...
    Permissions = [
        ...
        { permission: 'Plant', view: false, add: false, edit: false, delete: false },
        { permission: 'Frequency', view: false, add: false, edit: false, delete: false },
        { permission: 'UnitOfMeasure', view: false, add: false, edit: false, delete: false },
        { permission: 'NatureOfWork', view: false, add: false, edit: false, delete: false },
        { permission: 'Department', view: false, add: false, edit: false, delete: false },
        { permission: 'Holiday', view: false, add: false, edit: false, delete: false },
        { permission: 'Activity', view: false, add: false, edit: false, delete: false },
        { permission: 'Kanban', view: false, add: false, edit: false, delete: false },
    ...
    private mapPermissionToCode(permissionName: string): string {
        ...
        const permissionMap = {
            ...
            'Role': 'PER_ROLE',
            'Plant': 'PER_PLANT',
            'Frequency': 'PER_FREQUENCY',
            'UnitOfMeasure': 'PER_UNIT_OF_MEASURE',
            'NatureOfWork': 'PER_NATURE_OF_WORK',
            'Department': 'PER_DEPARTMENT',
            'Holiday': 'PER_HOLIDAY',
